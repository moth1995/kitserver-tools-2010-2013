...
HWND g_lodLabel13;
HWND g_lodLabel14;
HWND g_lodTrackBarControl[14];
HWND g_lodEditControl[14];
...
bool BuildControls(HWND parent)
{
    ...
    UINT th = 28;
    borH = th*7 + spacer*12 + butH + statH*3 + spacer*3;
	...
	HWND lodTitle = CreateWindowEx(
			xstyle, L"Static", L"Custom LOD (Level-Of-Detail) configuration", WS_CHILD | WS_VISIBLE,
			x, y, 260, butH,
			parent, NULL, NULL, NULL);
