...
#define DEFAULT_DEMO_EXE_NAME L"pes2013.exe\0"
#define BUFLEN 4096
...
void MyMessageBox(wchar_t* fmt, DWORD value)
{
	...
	MessageBox(hWnd, buf, L"Kitserver 13 DEBUG MyMessage", 0);
#endif
}
...
%s.", fileName);
            ...
            if (GetGameVersion(GetRealGameVersion(fileName)) >= gvPES2013demo1) {
