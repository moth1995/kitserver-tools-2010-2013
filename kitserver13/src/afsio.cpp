...
#define MODID 123
#ifdef DEBUG
#define NAMELONG L"AFSIO Module 13.0.0.0 (DEBUG)"
#else
#define NAMELONG L"AFSIO Module 13.0.0.0"
#endif
...
KEXPORT void getConfig2(char* section, char* name, BYTE dataType, DWORD a, PROCESSCONFIG callback);
...
KEXPORT void RegisterKModule2(KMOD *k);
...
void afsioAtGetBufferSizeCallPoint()
{
    __asm {
        ...
        push esi
        push edi
       //MOV EDX,DWORD PTR DS:[EBX+10]  // original code
		MOV EAX,DWORD PTR DS:[EDX*4+ECX]// get size
		mov ecx, dword ptr ds:[ebx+0x0c]// get ID
...
void afsioAtGetBufferSizeCallPoint_bk()
{
    __asm {
        // IMPORTANT: when saving flags, use pusfd/popfd for stack alignment
        pushfd 
