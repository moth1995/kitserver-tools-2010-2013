...
EXTERN_C BOOL WINAPI DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved)
{
	if (dwReason == DLL_PROCESS_ATTACH)
	{
        ...
        if (g_pesinfo.gameVersion == gvPES2010)
        {
        ...
        else if (g_pesinfo.gameVersion == gvPES2010v11)
        {
            DWORD newProtection = PAGE_EXECUTE_READWRITE;
            DWORD g_savedProtection;
            if (VirtualProtect((BYTE*)0x400d68, 4, 
        ...
        else if (g_pesinfo.gameVersion == gvPES2010v12)
        {
            DWORD newProtection = PAGE_EXECUTE_READWRITE;
            DWORD g_savedProtection;
            if (VirtualProtect((BYTE*)0x400d68, 4, 
        ...
        else if (g_pesinfo.gameVersion == gvPES2010v13)
        {
            DWORD newProtection = PAGE_EXECUTE_READWRITE;
            DWORD g_savedProtection;
            if (VirtualProtect((BYTE*)0x400d68, 4, 
