...
void fservReadEditData(LPCVOID dta, DWORD size);
...
void fservReadBalData(LPCVOID dta, DWORD size);
void fservWriteBalData(LPCVOID dta, DWORD size);
...
void fservReadEditData(LPCVOID dta, DWORD size)
{
    ...
    PLAYER_INFO* players = (PLAYER_INFO*)((BYTE*)dta + 0x1a0);
