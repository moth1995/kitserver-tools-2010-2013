...
#define MAX_FACE_ID 2130 //1700
#define MAX_HAIR_ID 2130 //1700
...
HRESULT STDMETHODCALLTYPE initModule(IDirect3D9* self, UINT Adapter,
    ...
    HookCallPoint(code[C_CHECK_FACE_AND_HAIR_ID], 
            fservAtFaceHairCallPoint, 3, 2); //1);
    ...
    HookCallPoint(code[C_GET_FACE_BIN],
            fservAtGetFaceBinCallPoint, DEFAULT_CODE_SHIFT, 4);
    HookCallPoint(code[C_GET_HAIR_BIN],
            fservAtGetHairBinCallPoint, DEFAULT_CODE_SHIFT, 0);
    HookCallPoint(code[C_RESET_HAIR],
            fservAtResetHairCallPoint, DEFAULT_CODE_SHIFT, 2);
    ...
    HookCallPoint(code[C_FACEHAIR_READ],
            fservAtUseFaceHairCallPoint, DEFAULT_CODE_SHIFT, 2);
    HookCallPoint(code[C_ONLINE_ENTER],
            fservAtOnlineEnterCallPoint, DEFAULT_CODE_SHIFT, 2);
...
void fservApplyChanges(PLAYER_INFO* players)
{
    ...
    afsioExtendSlots(0x0c,63000); // 57000);
